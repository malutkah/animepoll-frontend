const LegalPage = () => {
    return (
        <>
            <div className="max-w-4xl mx-auto p-6 bg-transparent shadow rounded my-8">
                ...
                <h4 className="text-lg font-medium mt-4 mb-2">Wer ist verantwortlich für die Datenerfassung auf dieser
                    Website?</h4>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-3">2. Hosting</h2>
                <p className="mb-4">Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>

                <h3 className="text-xl font-semibold mt-4 mb-2">Externes Hosting</h3>
                <p className="mb-4">
                ...
                <h4 className="text-lg font-medium mt-4 mb-2">Auftragsverarbeitung</h4>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-3">3. Allgemeine Hinweise und Pflichtinformationen</h2>
                ...
                <p className="mb-4">
                    Alan Tressin<br/>
                    c/o MDC Management#689<br/>
                    Welserstraße 3<br/>
                    87463 Dietmannsried
                </p>
                <p className="mb-4">
                    E-Mail: contact@animepoll.net
                </p>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mt-4 mb-2">Allgemeine Hinweise zu den Rechtsgrundlagen der
                ...
                <p className="mb-4">
                    ...
                    sofern diese zur Erfüllung einer rechtlichen Verpflichtung erforderlich sind auf Grundlage von Art.
                ...
                <p className="mb-4">
                    ...
                    f DSGVO an der Weitergabe haben oder wenn eine sonstige Rechtsgrundlage die Datenweitergabe erlaubt.
                    Beim Einsatz von Auftragsverarbeitern geben wir personenbezogene Daten unserer Kunden nur auf
                    Grundlage eines gültigen Vertrags über Auftragsverarbeitung weiter. Im Falle einer gemeinsamen
                ...
                <h3 className="text-xl font-semibold mt-4 mb-2">Widerspruchsrecht gegen die Datenerhebung in besonderen
                    Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mt-4 mb-2">Beschwerderecht bei der zuständigen
                    Aufsichtsbehörde</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mt-4 mb-2">Widerspruch gegen Werbe-E-Mails</h3>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-3">4. Datenerfassung auf dieser Website</h2>
                ...
                <h3 className="text-xl font-semibold mt-4 mb-2">Kommentarfunktion auf dieser Website</h3>
                <p className="mb-4">
                ...
                <h4 className="text-lg font-medium mt-4 mb-2">Speicherdauer der Kommentare</h4>
                <p className="mb-4">
                ...
                <h4 className="text-lg font-medium mt-4 mb-2">Rechtsgrundlage</h4>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    Quelle: <a className="text-blue-500 underline" href="https://www.e-recht24.de" target="_blank"
